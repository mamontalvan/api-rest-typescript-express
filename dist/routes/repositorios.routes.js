...
router.post('/', [
    ...
    (0, express_validator_1.body)('state', 'El estado es obligatorio').not().isEmpty(),
    (0, express_validator_1.check)('state', 'Sólo se permite registrar los estados: E, D, A ').isIn(['E', 'D', 'A']),
    (0, express_validator_1.body)('tribuId', 'El identificador de la tribu es obligatorio').not().isEmpty(),
    (0, express_validator_1.body)('tribuId').custom((tribuId) => (0, db_validators_1.validaIdTribu)(tribuId)),
    (0, express_validator_1.body)('codigoVerificacion', 'El código de verificación es obligatorio').not().isEmpty(),
    (0, express_validator_1.check)('codigoVerificacion', 'Códigos de verificación permitidos: 604, 605, 606 ').isIn([604, 605, 606]),
...
router.put('/:id', [
    (0, express_validator_1.body)('name').custom((name) => (0, db_validators_1.validaNombreRepositorio)(name)),
    (0, express_validator_1.check)('state', 'Sólo se permite registrar los estados: E, D, A ').isIn(['E', 'D', 'A']),
    (0, express_validator_1.body)('codigoVerificacion').custom((codigoVerificacion) => (0, db_validators_1.validaCodigosVerificacion)(codigoVerificacion)),
    (0, express_validator_1.body)('tribuId').custom((tribuId) => (0, db_validators_1.validaIdTribu)(tribuId)),
    validaCampos_1.validarCampos
...
//# sourceMappingURL=repositorios.routes.js.map